...
<div class="header">
 ...
 <form action="search.php" method="GET">
    ...
    <form action="filmadd.php" method="POST" onsubmit=" return confirmInsert();">
        <table>
            <tr>
    ...
    function validateForm() {
        ...
        if (fname === "" || lname === "" || email === "" || telephone === "" || nationality === "") {
    ...
    function clearForm() {
        document.getElementById("filmmakerForm").reset();
    }

    // Adding event listener to form submission
    document.getElementById("filmmakerForm").addEventListener("submit", function(event) {
        if (!validateForm()) {
