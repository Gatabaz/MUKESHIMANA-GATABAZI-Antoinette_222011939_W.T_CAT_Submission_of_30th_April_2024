...
<div class="header">
 ...
 <form action="search.php" method="GET">
    ...
    <form action="controadd.php" method="POST" onsubmit=" return confirmInsert();">
        <table>
            <tr>
            ...
            <tr>
                <td>Position</td>
                <td><select class="size" name="position" required>
                    <option value="chose">Select</option>
                        <option value="Filmmaker">Manager</option>
             ...
             <tr>
                <td>First Name</td>
                <td><input class="size" type="text" name="firstname" required="" placeholder="Enter firstname"></td><br><br>
            </tr>
            <tr>
                <td>Last name</td>
                <td><input class="size" type="text" name="lastname" required="" placeholder="Enter lastname"></td><br><br>
            </tr>
            ...
            <tr>
                <td>Telephone</td>
                <td><input class="size" type="text" name="telephone" required="" placeholder="Enter Telephone"></td><br><br>
            </tr>
             <tr>
                <td>Contract sign date</td>
                <td><input class="size" type="date" name="contract_date" required=""></td><br><br>
            </tr>
             <tr>
                <td>Contract Text</td>
                <td><input class="size" type="text" name="contract_text" required="" placeholder="Enter text Contract"></td><br><br>
            </tr>
            <tr>
                <td>Nationality</td>
                <td>
