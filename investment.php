...
<div class="header">
    ...
    <ul class="navigation">
      <li><a href="menu1.php">Home</a></li>
        ...
        <a href="filmview.php">Filmmaker table</a>
          ...
          <a href="contractvew.php">Contract Table</a>
        </div>
      </li>
        <li class="dropdown">
      <a href="#">Settings</a>
 ...
 <form action="search.php" method="GET">
    ...
    <form action="investmeadd.php" method="POST" onsubmit=" return confirmInsert();">
        <table>
            <tr>
                <h3 style="font-size: 20px;color: white;"><i>Filmmaker Form</i></h3>
            </tr>
            <tr>
                <td>Firstname</td>
                <td><input class="size" type="text" name="firstname" id="fname"></td> <br><br>
            </tr>
            <tr>
                <td>Lastname</td>
                <td><input class="size" type="text" name="lastname" id="lname"></td><br><br>
            </tr>
            <tr>
                <td>Email</td>
                <td><input class="size" type="text" name="email" required=""></td><br><br>
            </tr>
            <tr>
                <td>Telephone</td>
                <td><input class="size" type="text" name="telephone" required=""></td><br><br>
            </tr>
            <tr>
                <td>Project Name</td>
                <td>
                    
                <select class="size" name="projectname" required>
                <option value="chose">Select</option>
                        <option value="The Hero">The Hero</option>
                        <option value="Bamenya">Bamenya</option>
                        <option value="Papa sava">Papasava</option>
                        <option value="Umuturanyi">Umuturanyi</option>
            ...
            <tr>
                ...
                <td><input class="size" type="number" name="investmentAmount" required=""></td><br><br>
            </tr>
            <tr>
                <td></td>
                <td>
                    <input type="submit" name="send" value="save" style="width: 150px;background-color: black;color: white;font-size: 30px;">
